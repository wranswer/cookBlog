...
{
if (code=="yulu"){
document.writeln('<script>var cpro_id = "u1991152";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="top728x90"){
document.writeln('<script>var cpro_id = "u1774079";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="top960x90"){
document.writeln('<script>var cpro_id = "u2018797";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="top234x90"){
document.writeln('<script>var cpro_id = "u2018827";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="top230x90_1"){
document.writeln('<script>var cpro_id = "u1786157";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="top230x90_2"){
document.writeln('<script>BAIDU_CLB_SLOT_ID = "288996";</script>');
...
document.writeln('data-ad-client="ca-pub-4213001413639273"');
document.writeln('data-ad-slot="4818925196"></ins>');
document.writeln('<script>');
document.writeln('(adsbygoogle = window.adsbygoogle || []).push({});');
document.writeln('</script>')}
if (code=="lb336x280_2"){
document.writeln('<script>var cpro_id = "u1785760";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="lb336x280_3"){
document.writeln('<script>BAIDU_CLB_SLOT_ID = "1001204";</script>');
document.writeln('<script type="text/javascript" src="http://cbjs.baidu.com/js/o.js"></script>')}

if (code=="lb160x600"){
document.writeln('<script>var cpro_id = "u1620356";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="lb728x90_1"){
document.writeln('<script>var cpro_id = "u1620358";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="lb728x90_2"){
document.writeln('<script>var cpro_id = "u1620417";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="lb468x15"){
document.writeln('<script>var cpro_id = "u1620365";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="ny336x280"){
document.writeln('<script>var cpro_id = "u1620373";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="ny300x250"){
document.writeln('<script>var cpro_id = "u1620374";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="ny728x90"){
//document.writeln('懒人 图库');
}
if (code=="ny728x90-b"){
document.writeln('<script>var cpro_id = "u1783998";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}

if (code=="js336x280"){
document.writeln('<script>var cpro_id = "u1786179";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="js856x90_1"){
document.writeln('<script>var cpro_id = "u1620410";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="js856x90_2"){
document.writeln('<script>var cpro_id = "u1620412";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
if (code=="js856x90_3"){
document.writeln('<script>var cpro_id = "u1620417";</script>');
document.writeln('<script type="text/javascript" src="http://cpro.baidustatic.com/cpro/ui/c.js"></script>')}
...
if (code=="in856x90_1"){
document.writeln('<script>BAIDU_CLB_SLOT_ID = "289000";</script>');
document.writeln('<script type="text/javascript" src="http://cbjs.baidu.com/js/o.js"></script>')}
if (code=="in856x90_2"){
document.writeln('<script>BAIDU_CLB_SLOT_ID = "288997";</script>');
document.writeln('<script type="text/javascript" src="http://cbjs.baidu.com/js/o.js"></script>')}
if (code=="in856x90_3"){
document.writeln('<script>BAIDU_CLB_SLOT_ID = "416044";</script>');
document.writeln('<script type="text/javascript" src="http://cbjs.baidu.com/js/o.js"></script>')}

if (code=="in336x90_1"){
document.writeln('<script>BAIDU_CLB_SLOT_ID = "289003";</script>');
document.writeln('<script type="text/javascript" src="http://cbjs.baidu.com/js/o.js"></script>')}
if (code=="in336x90_2"){
document.writeln('<script>BAIDU_CLB_SLOT_ID = "289007";</script>');
document.writeln('<script type="text/javascript" src="http://cbjs.baidu.com/js/o.js"></script>')}
if (code=="in336x90_3"){
document.writeln('<script>BAIDU_CLB_SLOT_ID = "548534";</script>');
document.writeln('<script type="text/javascript" src="http://cbjs.baidu.com/js/o.js"></script>')}
...
document.writeln('style="display:inline-block;width:336px;height:280px"');
document.writeln('data-ad-client="ca-pub-4213001413639273"');
document.writeln('data-ad-slot="0184472201"></ins>');
document.writeln('<script>');
document.writeln('(adsbygoogle = window.adsbygoogle || []).push({});');
document.writeln('</script>')}
if (code=="xf300x250"){
document.writeln('<script>var cpro_id = "u1620407";</script>');
...
if (code=="egg"){
document.write('* 懒人图库承诺：本站所有资源免费下载，无病毒，无弹窗，无干扰链接！<a href="http://koubei.baidu.com/s/lanrentuku.com" target="_blank">给个点评</a>');}
if (code=="jinbu"){// 进步
document.write('<dd>03月10日 高清图片素材频道上线</dd>');
document.write('<dd>11月01日 网页宽度升至1200像素</dd>');
document.write('<dd>06月21日 优化素材下载地址~</dd>');
document.write('<dd>03月01日 折页网上线 http://zheye.cc/</dd>');
document.write('<dd>...</dd>');}
if (code=="tj"){// 统计
var _hmt = _hmt || [];
(function() {
  var hm = document.createElement("script");
  hm.src = "//hm.baidu.com/hm.js?49542e19848a99b43a81376b929e6c72";
...
document.writeln('<img src="http://bdimg.share.baidu.com/static/images/type-button-2.jpg?cdnversion=20120831" />');
document.writeln('<a class="shareCount"></a>');
document.writeln('</div>');
document.writeln('<script type="text/javascript" id="bdshare_js" data="type=slide&amp;img=2&amp;pos=right&amp;uid=12879" ></script>');
...
//花瓣
(function(d,t) {
  window.huaban_minWidth = 250;
  window.huaban_minHeight = 250;
  window.huaban_md = "lanrentuku_com";
...
switch(all_var)
{case"png": document.formsearch.action='http://www.lanrentuku.com/png/search.php?type=search&q='+q
break;case"js":document.formsearch.action='http://www.lanrentuku.com/js/search/q='+q
break;
default:
        var Sys = {};
...
document.formsearch.action='http://www.lanrentuku.com/s.php?typeid='+all_var+'&q='+q;break;}
